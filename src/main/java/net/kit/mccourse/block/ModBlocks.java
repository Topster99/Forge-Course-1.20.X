package net.kit.mccourse.block;

import net.kit.mccourse.MCCourseMod;
import net.kit.mccourse.block.custom.SoundBlock;
import net.kit.mccourse.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> END_STONE_ALEXANDRITE_ORE = registerBlock("end_stone_alexandrite_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.END_STONE)
                    .strength(5f).requiresCorrectToolForDrops(), UniformInt.of(6, 8)));
